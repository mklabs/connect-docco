...
send, parse, highlight, escape, pigmentize,
...
// Highlights a single chunk of code, using **Pygments** over stdio, and runs the text of its corresponding comment through **Markdown**, using the **Github-flavored-Markdown** modification of [Showdown.js](http://attacklab.net/showdown/).
